pro btslope, inlist, output
  ...
  for ii = 0, nfiles - 1 do begin
     ...
     time    = evodata.INNFL_TIME
     z       = evodata.INNFL_REDSHIFT
     tobs    = evodata.INNFL_TOBS
     epochs  = value_locate(time, tobs+[-1,0])
     
     mghInner0 = evodata.INNFL_MGH[epochs[0],1]
     mghInner1 = evodata.INNFL_MGH[epochs[1],1]
     mghInnErr0 = 0.5 * (evodata.INNFL_MGH[epochs[0],2] - evodata.INNFL_MGH[epochs[0],0])
     mghInnErr1 = 0.5 * (evodata.INNFL_MGH[epochs[1],2] - evodata.INNFL_MGH[epochs[1],0])
